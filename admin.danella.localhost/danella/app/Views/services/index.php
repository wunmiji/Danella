...
<div class="d-flex justify-content-between">
	...
	<div><a href="/services/create" class="btn primary-btn">New Service</a></div>
</div>
							...
							<?php else: ?>
								...
								<?php foreach ($data as $key => $value): ?>
									...
									<tr>
										...
										<td class="pe-4 text-nowrap"><a href="services/<?=  \App\Libraries\SecurityLibrary::encryptUrlId($value->id); ?>"
