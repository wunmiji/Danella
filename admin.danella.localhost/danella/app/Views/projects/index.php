...
<div class="d-flex justify-content-between">
	...
	<div><a href="/projects/create" class="btn primary-btn">New Project</a></div>
</div>
							...
							<?php else: ?>
								...
								<?php foreach ($data as $key => $value): ?>
									...
									<tr>
										...
										<td class="pe-4 text-nowrap"><a href="projects/<?= \App\Libraries\SecurityLibrary::encryptUrlId($value->id); ?>"
