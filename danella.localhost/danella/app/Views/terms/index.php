...
<!-- corousel-section -->
<?php $dataCarousel = [
	'dataCarouselImage' => '/assets/images/terms-featured-area.jpg',
	'dataCarouselTitle' => 'Terms',
	'dataCarouselSubTitle' => 'We encourage all customers to carefully review the terms and conditions ',
...
<!-- terms-section -->
<?php // https://www.freeprivacypolicy.com/live/85f3c45e-6245-4fa8-9d12-f5b5c7664e28  ?>
<?php // https://www.freeprivacypolicy.com/live/85f3c45e-6245-4fa8-9d12-f5b5c7664e28  ?>
<?php // https://www.freeprivacypolicy.com/live/85f3c45e-6245-4fa8-9d12-f5b5c7664e28  ?>
	...
	<div class="container">
		<div class="row row-cols-1">
			<div class="card">
				<div class="card-body">
					<div class="mb-4">
						<div class="card-title fw-bold">Terms and Conditions</div>
					...
					<div class="mb-4">
						<div class="card-title fw-bold">Interpretation</div>
					...
					<div class="mb-4">
						<div class="card-title fw-bold">Definitions</div>

						<p>For the purposes of these Terms and Conditions:</p>
						<ul class="word-list">
							<li>
								<span class="strong">Affiliate</span>
								<p>means an entity that controls, is controlled by or is
									under
							...
							<li>
								...
								<p>refers to: Nigeria</p>
							</li>
							<li>
								<span class="strong">Company</span>
								<p>(referred to as either &quot;the Company&quot;,
									&quot;We&quot;,
									&quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to
									<?= $information['name']; ?> Sole
									Proprietor, <?= $information['address']; ?>
								</p>
							</li>
							<li>
								<span class="strong">Device</span>
								<p>means any device that can access the Service such as a
									computer,
							...
							<li>
								<span class="strong">Third-party Social Media Service</span>
								<p>means any services or content
							...
							<li>
								...
								<p>refers to <?= $information['name']; ?>, accessible from <a
										href="<?= $information['website']; ?>" rel="external nofollow noopener"
										target="_blank"><?= $information['website']; ?></a></p>
							</li>
							<li>
								<span class="strong">You</span>
								<p>means the individual accessing or using the Service, or the
									company,
					...
					<div class="mb-4">
						<div class="card-title fw-bold">Acknowledgment</div>
					...
					<div class="mb-4">
						<div class="card-title fw-bold">Links to Other Websites</div>
					...
					<div class="mb-4">
						<div class="card-title fw-bold">Termination</div>
					...
					<div class="mb-4">
						<div class="card-title fw-bold">Limitation of Liability</div>
					...
					<div class="mb-4">
						<div class="card-title fw-bold">&quot;AS IS&quot; and &quot;AS AVAILABLE&quot;
							Disclaimer</div>

						<p>The Service is provided to You &quot;AS IS&quot; and &quot;AS AVAILABLE&quot; and
							with all
							faults
							and defects without warranty of any kind. To the maximum extent permitted under applicable
							law,
							...
							operate without interruption, meet any performance or reliability standards or be error free
							or
					...
					<div class="mb-4">
						<div class="card-title fw-bold">Governing Law</div>
					...
					<div class="mb-4">
						<div class="card-title fw-bold">Disputes Resolution</div>
					...
					<div class="mb-4">
						<div class="card-title fw-bold">Severability</div>
					...
					<div class="mb-4">
						<div class="card-title fw-bold">Waiver</div>
					...
					<div class="mb-4">
						<div class="card-title fw-bold">Translation Interpretation</div>
					...
					<div class="mb-4">
						<div class="card-title fw-bold">Changes to These Terms and Conditions</div>
